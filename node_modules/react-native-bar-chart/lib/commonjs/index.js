...
var _reactNativeDash = _interopRequireDefault(require("react-native-dash"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const defaultHeight = _reactNative.Dimensions.get('window').height / 2.2;
let max = 0;
...
const HorizontalDots = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    }, labelText)), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: {
        flex: 0.875
      }
    }, /*#__PURE__*/_react.default.createElement(_reactNativeDash.default, {
      style: {
        width: '100%',
        height: 1
      },
...
const HorizontalLablesData = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    }, data[index].constructor === Array ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: {
        alignItems: 'center'
      }
    }, /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    ...
    }, `${prefix || ''}${data[index][0].toString()}${suffix || ''}`), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: {
        width: 15,
    ...
    }, `${prefix || ''}${data[index][1].toString()}${suffix || ''}`), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: {
        width: 15,
        borderTopLeftRadius: 4,
        borderTopRightRadius: 4,
    ...
    }, `${prefix || ''}${data[index].toString()}${suffix || ''}`), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: {
        width: 15,
        borderTopLeftRadius: 4,
        borderTopRightRadius: 4,
...
const BarChart = props => {
  ...
  }, /*#__PURE__*/_react.default.createElement(HorizontalDots, {
    labels: verticalLabels,
    prefix: props.prefix,
    suffix: props.suffix,
    labelColor: props.labelColor
  }), /*#__PURE__*/_react.default.createElement(HorizontalLablesData, {
